...
const addCart = ()=> {
  if(skuObj.skuId){
    ...
    cartStore.addCart({
      ...
      picture: detailData.value.mainPictures,
    ...
    <div class="container" v-if="detailData.details">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item :to="{ path: `/categroy/${detailData.categories[1].id}` }">{{ detailData.categories[1].name }}
          </el-breadcrumb-item>
          <el-breadcrumb-item :to="{ path: `/categroy/${detailData.categories[0].id}` }">{{ detailData.categories[0].name }}
          </el-breadcrumb-item>
