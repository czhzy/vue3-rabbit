...
import {useCategroy} from '@/views/Category/composables/useCategory'
const { homeList } = useBanner()
...
<template>
  <div class="top-category">
    <div class="container m-top-20">
      ...
      <div class="home-banner">
       <el-carousel height="500px">
        <el-carousel-item v-for="item in homeList" :key="item.id">
    ...
    <div class="ref-goods" v-for="item in categroyData.children" :key="item.id">
      <div class="head">
          <h3>- {{ item.name }}-</h3>
        </div>
        <div class="body">
